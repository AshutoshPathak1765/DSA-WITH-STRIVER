...
// YT Link:- https://www.youtube.com/watch?v=zoilQD1kYSg&list=PLgUwDviBIf0qUlt5H_kiKYaNSqJ81PMMY&index=20
...
int targetSum(int n, int target, vector<int>& arr) {
    ...
    // s1+s2=S
    // s1=(target+S)/2
    // dp(i,s)-> Number of ways to make a target of s if given elements from [0..i]
    // final answer-> dp(n-1,(S+target)/2) where S= sum of the array
    // Recurrence-> dp(i,s)= dp(i-1,s)+dp(i-1,s-arr[0])
    // Base Case-> dp(i,0)=1
